/*const questions = [
    ...
    {
        question: "How many fish die from plastic every day?",
        optionA: "100,000",
        optionB: "12 million",
        optionC: "1 million",
        optionD: "110,453",
    ...
    {
        question: "What can you do to stop water pollution?",
        optionA: "Stay away from the ocean",
        optionB: "Go swimming",
        optionC: "Pick up trash",
        optionD: "Flush the toilet",
...
let image = ['dauphin.png', 'bleu.png' , 'her.png' , 'poissonn.png' ,'turtle.png','rose.png'];
let ident = ['Image1', 'Image2' , 'Image3','Image4','Image5','Image6'];
let i=0;
...
function checkForAnswer() {
    ...
    options.forEach((option) => {
        if (option.checked === true && option.value === currentQuestionAnswer) {
            ...
            document.getElementById(ident[i]).src=image[i]  
            i++
